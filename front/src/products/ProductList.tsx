...
export const productFilters = [
  ...
  <NumberInput source="width@gte" />,
  <NumberInput source="width@lte" />,
  <NumberInput source="height@gte" />,
  <NumberInput source="height@lte" />,
  <QuickFilter
    label="resources.products.fields.stock@lte"
    source="stock@lte"
    defaultValue={10}
  />,
];
