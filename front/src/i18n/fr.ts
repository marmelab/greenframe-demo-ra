  ...
  resources: {
    ...
    commands: {
      ...
      fields: {
        ...
        address: "Adresse",
        customer_id: "Client",
        "date@gte": "Emises depuis",
        "date@lte": "Emises avant",
        nb_items: "Nb articles",
        reference: "Référence",
        returned: "Annulée",
        status: "Etat",
        "total@gte": "Montant minimum",
      },
      section: {
        order: "Commande",
        customer: "Client",
    ...
    products: {
      ...
      fields: {
        ...
        "height@gte": "Hauteur mini",
        "height@lte": "Hauteur maxi",
        height: "Hauteur",
        image: "Photo",
        price: "Prix",
        reference: "Référence",
        sales: "Ventes",
        "stock@lte": "Stock faible",
        stock: "Stock",
        thumbnail: "Aperçu",
        "width@gte": "Largeur mini",
        "width@lte": "Margeur maxi",
        width: "Largeur",
      },
      tabs: {
        image: "Image",
    ...
    reviews: {
      ...
      fields: {
        ...
        command_id: "Commande",
        product_id: "Produit",
        "date@gte": "Publié depuis",
        "date@lte": "Publié avant",
        date: "Date",
        comment: "Texte",
        status: "Statut",
        rating: "Classement",
